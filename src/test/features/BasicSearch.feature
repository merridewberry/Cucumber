Feature: Testing basic search function
  ...
  Scenario: Basic positive test
    Given I enter movie title "Swiss Army Man" into the search field
  ...
  Scenario: Searching for movie with clicking on the "All results" link
    Given I enter movie title "Swiss Army Man" into the search field
    And I click "All results" link
    And I click on the searched movie link
    Then movie URL is correct


  Scenario: Searching for movie with clicking the search button
    Given I enter movie title "Swiss Army Man" into the search field
    And I press the search button
    And I click on the searched movie link
    Then movie URL is correct
